 ...
 * written to the host at /home/pierre/coolify/applications/{uuid}/. The start
...
it('generates host command (not executeInDocker) when preserveRepository is true', function () {
    ...
    $serverWorkdir = '/home/pierre/coolify/applications/app-uuid';
    $basedir = '/artifacts/test-deployment-uuid';
    $preserveRepository = true;

    $startCommand = 'docker compose -f /home/pierre/coolify/applications/app-uuid/compose.yml --env-file /home/pierre/coolify/applications/app-uuid/.env --profile all up -d';
...
it('injects --project-directory with container path when preserveRepository is false', function () {
    ...
    expect($customStartCommand)->not->toContain('/home/pierre/coolify/applications/');
});
...
it('uses container paths for env-file when preserveRepository is false', function () {
    ...
    expect($startCommand)->not->toContain('/home/pierre/coolify/applications/');
});
