    ...
    <div class="flex flex-col h-full gap-8 sm:flex-row">
        ...
        <div class="flex flex-col gap-4">
                    ...
                    <div class="flex gap-2">
                        <x-modal-confirmation title="Confirm changing of CA Certificate?" buttonTitle="Save"
                            submitAction="saveCaCertificate" :actions="[
                                'This will overwrite the existing CA certificate at /home/pierre/coolify/ssl/coolify-ca.crt with your custom CA certificate.',
                            ...
                            confirmationText="/home/pierre/coolify/ssl/coolify-ca.crt" shortConfirmationLabel="CA Certificate Path"
                        ...
                        <x-modal-confirmation title="Confirm Regenerate Certificate?" buttonTitle="Regenerate "
                            submitAction="regenerateCaCertificate" :actions="[
                                'This will generate a new CA certificate at /home/pierre/coolify/ssl/coolify-ca.crt and replace the existing one.',
            ...
            <div class="space-y-4">
                ...
                <div class="relative">
                    <x-forms.copy-button text="- /home/pierre/coolify/ssl/coolify-ca.crt:/etc/ssl/certs/coolify-ca.crt:ro" />
                </div>
            </div>
            <div>
