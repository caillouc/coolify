...
class PrivateKey extends BaseModel
{
    ...
    protected function ensureStorageDirectoryExists()
    {
        ...
        if (! $testSuccess) {
            throw new \Exception('SSH keys storage directory is not writable. Run on the host: sudo chown -R 9999 /home/pierre/coolify/ssh && sudo chmod -R 700 /home/pierre/coolify/ssh && docker restart coolify');
        }
