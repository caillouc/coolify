...
5. **Updating the CDN**
   - To make a new version publicly available, the version information on the CDN needs to be updated manually. After that the new version number will be available at [https://raw.githubusercontent.com/caillouc/coolify/refs/heads/v4.x/versions.json](https://raw.githubusercontent.com/caillouc/coolify/refs/heads/v4.x/versions.json).
...
- **Stable**
  ...
  - **Installation Command:**
    ```bash
    curl -fsSL https://raw.githubusercontent.com/caillouc/coolify/refs/heads/v4.x/install.sh | bash
    ```
...
- **Nightly**
  ...
  - **Installation Command:**
    ```bash
    curl -fsSL https://raw.githubusercontent.com/caillouc/coolify/refs/heads/v4.x-nightly/install.sh | bash -s next
    ```
...
```bash
curl -fsSL https://raw.githubusercontent.com/caillouc/coolify/refs/heads/v4.x/install.sh | bash -s <version>
```
